...
main.py \
--bin_edges 0.1 \
--pretrained_model_path 'model_configs/distilbert_base.json' \
--shard_size 10000 \
--eval_data_paths '/home/rohola/TabulaSapiens/ranked/Tabula_Sapiens_ranked_47.h5ad' \
--max_length 1024 \
--num_top_genes 58604 \
...
--train_data_paths '/home/rohola/TabulaSapiens/ranked/Tabula_Sapiens_ranked_{0..43}.h5ad' \
...
#--bin_edges 0.1 \
#--pretrained_model_path 'transformeromics/model_configs/distilbert_large.json' \
#--shard_size 10000 \
#--eval_data_paths 'transformeromics/data/validation_data/seq1024_mlm_gene000_pheno050_shard0_v0.json' 'transformeromics/data/validation_data/seq1024_mlm_gene015_pheno050_shard0_v0_no_pheno.json' \
#--max_length 1024 \
#--num_top_genes 58604 \
